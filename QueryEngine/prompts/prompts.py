...
**【重要】相关性约束**：
- **严格贴合原始主题**：所有引用的新闻、数据必须直接相关于段落标题和原始研究主题
- **禁止混入无关热点**：不要将同名人物的其他事件、相邻时间的无关热点当作主题证据
- **数据来源验证**：引用的所有内容必须真实来自搜索结果，不得编造或引用不存在的新闻
- **实体一致性检查**：确保讨论的人物、事件、机构等核心实体与原始主题一致
...
**【重要】相关性约束**：
- **严格贴合原始主题**：新增的所有新闻、数据必须直接相关于段落标题和原始研究主题
- **禁止混入无关热点**：不要将同名人物的其他事件、相邻时间的无关热点作为补充证据
- **数据来源验证**：所有新增内容必须来自搜索结果，不得编造或引用不存在的新闻
